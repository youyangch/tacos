package com.belence.tacos.repository.impl;

import com.belence.tacos.entity.IngredientRef;
...
public class JdbcOrderRepository implements OrderRepository {
    ...
    public TacoOrder save(TacoOrder order){
        PreparedStatementCreatorFactory pscf =
                new PreparedStatementCreatorFactory("insert into Taco_Order (delivery_name,delivery_street,delivery_city,delivery_state,delivery_zip,cc_number,cc_expiration,cc_cvv,placed_at) values(?,?,?,?,?,?,?,?,?)",
    ...
    private long saveTaco(Long orderId,int orderKey,Taco taco){
        ...
        PreparedStatementCreatorFactory pscf = new PreparedStatementCreatorFactory("insert into Taco(name,created_at,taco_order,taco_order_key) values (?,?,?,?)",
